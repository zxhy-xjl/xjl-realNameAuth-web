...
<script type="text/javascript">
	...
	$(function() {
		...
		if(msg!=""){
			if(msg=="success"){
				showError("密码修改成功!:<a href='view/login.jsp'>立即登录</a>");
			}
		}
		//按钮样式
	    $("button").button()
...
<body>
<form id="forgetPassword"  name="forgetPasswordName" action="rest/realNameAuth/doUpdatePassword">
...
<table  width="100%"  class="table_class">
	...
	<tr>
		<td><button id="sendCode" onclick="doSendCode();" class="button" >发送验证码</button></td>
	</tr>
	<tr>
		<td><span id="showCount"  class="showCount_class" ></span><br/>验&nbsp;&nbsp;证&nbsp;&nbsp;码：<input id="code" class="input" name="code" type="text"/></td>
	</tr>
	<tr>
		<td>设置密码：<input id="pwd" class="input" name="pwd" type="password"/></td>
	</tr>
	<tr>
		<td>确认密码：<input id="rppwd" class="input" name="rppwd" type="password"/></td>
	</tr>
	<tr>
		<td><button id="affirm" class="button" onclick="doAffirm();" >确定</button></td>
	</tr>
	<tr>
